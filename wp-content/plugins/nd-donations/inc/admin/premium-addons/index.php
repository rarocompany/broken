          ...
          <div class="nd_donations_section">
              ...
              <table id="nd_donations_table_premium_addons" class="nd_donations_width_60_percentage nd_donations_margin_auto nd_donations_border_collapse_collapse">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <h2 class="nd_donations_section nd_donations_margin_0"><?php _e('Credit Card','nd-donations'); ?></h2>
                      <p class="nd_donations_color_666666 nd_donations_section nd_donations_margin_0 nd_donations_margin_top_10"><?php _e('Pay with credit card for all causes','nd-donations'); ?>. <a target="_blank" href="https://goo.gl/UR8UgO"><?php _e('View Demo','nd-donations'); ?></a></p>
                    </td>
