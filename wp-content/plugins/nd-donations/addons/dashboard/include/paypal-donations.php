...
//create Menu
add_action('nd_donations_add_menu_settings','nd_donations_add_paypal_donations_page');
function nd_donations_add_paypal_donations_page(){

  add_submenu_page( 'nd-donations-settings','ND Pay Donations', __('Pay Donations','nd-donations'), 'manage_options', 'nd-donations-paypal-donations-page', 'nd_donations_paypal_donations_page' );
...
//nd_donations_paypal_donations
class nd_donations_paypal_donations extends WP_List_Table
{
  

  //prepare all donations
  function nd_donations_prepare_paypal_donations()
  {
    ...
    $nd_donations_action_type_2 = "'stripe'";
    ...
    $nd_donations_all_orders = $wpdb->get_var(
      "SELECT COUNT(id) FROM $nd_donations_table_name WHERE action_type = $nd_donations_action_type OR action_type = $nd_donations_action_type_2");
 
    
    $this->items = $wpdb->get_results($wpdb->prepare(
            "SELECT * FROM $nd_donations_table_name ".
            "WHERE action_type = $nd_donations_action_type".
            "OR action_type = $nd_donations_action_type_2".
  ...
  function get_columns()
  {
    $nd_donations_columns = array(
      ...
      'paypal_currency' => __('Currency','nd-donations'),
...
//nd_donations_paypal_donations_page
function nd_donations_paypal_donations_page()
{
  
  $nd_donations_table = new nd_donations_paypal_donations();
  $nd_donations_table->nd_donations_prepare_paypal_donations();
          ...
          <table class="form-table">
            <tbody>
             ...
             <tr class="nd_donations_display_none">
              ...
              <tr>
                <th scope="row">
                  <label>'.__('Paypal Payment Status','nd-donations').'</label>
                </th>
                <td>
              ...
              <tr>
                ...
                <td>
              <input name="nd_donations_order_info_paypal_currency" readonly class="regular-text" type="text" value="'.$nd_donations_donation_info->paypal_currency.'">
              </td>
              </tr>
              ...
              <tr>
                <th scope="row">
                  <label>'.__('Paypal Email','nd-donations').'</label>
                </th>
                <td>
              ...
              <tr>
                <th scope="row">
                  <label>'.__('Paypal Tx','nd-donations').'</label>
                </th>
                <td>
              ...
              <tr class="">
                ...
                <td>
              <input name="nd_donations_order_info_action_type" readonly class="regular-text"  type="text" value="'.$nd_donations_donation_info->action_type.'">
              </td>
              </tr>
  ...
  //DISPLAY ALL ORDERS
    ...
    echo '<div class="wrap">';
    echo '<h2>'.__('Paypal Donations','nd-donations').'</h2>';   
