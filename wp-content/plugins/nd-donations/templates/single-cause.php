		    		...
		    		if ( is_user_logged_in() == 1 ){
			    		...
			    		<div class="nd_donations_section">
			    			...
			    			<div class="nd_donations_width_50_percentage nd_donations_float_left nd_donations_padding_left_15 nd_donations_padding_0_responsive nd_donations_box_sizing_border_box nd_donations_width_100_percentage_responsive">
			    				<input onclick="nd_donations_single_cause_form_filter()" id="nd_donations_single_cause_form_donation_address" onchange="nd_donations_single_cause_form_filter()" class="nd_donations_section" name="nd_donations_address" type="text" placeholder="'.__('Address','nd-donations').'">
			    			</div>
			    		</div>
			    		<div class="nd_donations_section nd_donations_height_20"></div>
			    		<div class="nd_donations_section">
			    			<div id="nd_donations_single_cause_form_donation_city_container" class="nd_donations_padding_bottom_20_important_responsive nd_donations_width_50_percentage nd_donations_float_left nd_donations_position_relative nd_donations_padding_right_15 nd_donations_padding_0_responsive nd_donations_box_sizing_border_box nd_donations_width_100_percentage_responsive">
			    				<input onclick="nd_donations_single_cause_form_filter()" onchange="nd_donations_single_cause_form_filter()" class="nd_donations_section" id="nd_donations_single_cause_form_donation_city" name="nd_donations_city" type="text" placeholder="'.__('City','nd-donations').'">
			    			</div>
			    			<div class="nd_donations_width_50_percentage nd_donations_float_left nd_donations_padding_left_15 nd_donations_padding_0_responsive nd_donations_box_sizing_border_box nd_donations_width_100_percentage_responsive">
			    				<input id="nd_donations_single_cause_form_donation_country" onclick="nd_donations_single_cause_form_filter()" onchange="nd_donations_single_cause_form_filter()" class="nd_donations_section" name="nd_donations_country" type="text" placeholder="'.__('Country','nd-donations').'">
			    			</div>
			    		</div>
			    		<div class="nd_donations_section nd_donations_height_20"></div>
			    		...
			    		<div class="nd_donations_section">
			    			<div id="nd_donations_single_cause_form_donation_name_container" class="nd_donations_position_relative nd_donations_width_50_percentage nd_donations_float_left nd_donations_padding_bottom_20_important_responsive nd_donations_padding_right_15 nd_donations_padding_0_responsive nd_donations_box_sizing_border_box nd_donations_width_100_percentage_responsive">
			    				<input onchange="nd_donations_single_cause_form_filter()" onclick="nd_donations_single_cause_form_filter()" class="nd_donations_section" id="nd_donations_single_cause_form_donation_name" name="nd_donations_name" type="text" placeholder="'.__('Name','nd-donations').'">
			    			</div>
			    			<div id="nd_donations_single_cause_form_donation_surname_container"  class="nd_donations_position_relative nd_donations_width_50_percentage nd_donations_float_left nd_donations_padding_left_15 nd_donations_padding_0_responsive nd_donations_box_sizing_border_box nd_donations_width_100_percentage_responsive">
			    				<input onchange="nd_donations_single_cause_form_filter()" onclick="nd_donations_single_cause_form_filter()" class="nd_donations_section" id="nd_donations_single_cause_form_donation_surname" name="nd_donations_surname" type="text" placeholder="'.__('Surname','nd-donations').'">
			    			</div>
			    		</div>
			    		<div class="nd_donations_section nd_donations_height_20"></div>
			    		<div class="nd_donations_section">
			    			<div id="nd_donations_single_cause_form_donation_email_container"  class="nd_donations_position_relative nd_donations_width_50_percentage nd_donations_float_left nd_donations_padding_bottom_20_important_responsive nd_donations_padding_right_15 nd_donations_padding_0_responsive nd_donations_box_sizing_border_box nd_donations_width_100_percentage_responsive">
			    				<input onchange="nd_donations_single_cause_form_filter()" onclick="nd_donations_single_cause_form_filter()" class="nd_donations_section" id="nd_donations_single_cause_form_donation_email" name="nd_donations_email" type="text" placeholder="'.__('Email','nd-donations').'">
			    			</div>
			    			<div class="nd_donations_width_50_percentage nd_donations_float_left nd_donations_padding_left_15 nd_donations_padding_0_responsive nd_donations_box_sizing_border_box nd_donations_width_100_percentage_responsive">
			    				<input onchange="nd_donations_single_cause_form_filter()" onclick="nd_donations_single_cause_form_filter()" class="nd_donations_section" name="nd_donations_address" id="nd_donations_single_cause_form_donation_address" type="text" placeholder="'.__('Address','nd-donations').'">
			    			</div>
			    		</div>
			    		<div class="nd_donations_section nd_donations_height_20"></div>
			    		<div class="nd_donations_section">
			    			<div id="nd_donations_single_cause_form_donation_city_container" class="nd_donations_padding_bottom_20_important_responsive nd_donations_width_50_percentage nd_donations_float_left nd_donations_position_relative nd_donations_padding_right_15 nd_donations_padding_0_responsive nd_donations_box_sizing_border_box nd_donations_width_100_percentage_responsive">
			    				<input onchange="nd_donations_single_cause_form_filter()" onclick="nd_donations_single_cause_form_filter()" class="nd_donations_section" id="nd_donations_single_cause_form_donation_city" name="nd_donations_city" type="text" placeholder="'.__('City','nd-donations').'">
			    			</div>
			    			<div class="nd_donations_width_50_percentage nd_donations_float_left nd_donations_padding_left_15 nd_donations_padding_0_responsive nd_donations_box_sizing_border_box nd_donations_width_100_percentage_responsive">
			    				<input onchange="nd_donations_single_cause_form_filter()" onclick="nd_donations_single_cause_form_filter()" class="nd_donations_section" name="nd_donations_country" id="nd_donations_single_cause_form_donation_country" type="text" placeholder="'.__('Country','nd-donations').'">
			    			</div>
			    		</div>
			    		<div class="nd_donations_section nd_donations_height_20"></div>
			    		<div id="nd_donations_single_cause_form_donation_message_container" class="nd_donations_section nd_donations_position_relative">
				...
				<div id="nd_donations_tab_payment_selection" class="nd_donations_tabs nd_donations_section nd_donations_position_relative ">
					...
					<div id="nd_donations_single_cause_step_3" class="nd_donations_section">
						...
						<ul class="nd_donations_list_style_none nd_donations_margin_0 nd_donations_padding_0 nd_donations_padding_0_responsive nd_donations_float_left nd_donations_padding_left_20">';
							...
							if ( get_option('nd_donations_stripe_public_key') != '' and get_option('nicdark_theme_author') == 1 ) {

								$nd_donations_result .= '
								<li class="nd_donations_display_inline_block nd_donations_margin_right_40">
									<h4>
										<a class="nd_donations_outline_0 nd_donations_padding_10_0 nd_donations_padding_top_5 nd_donations_display_inline_block nd_options_first_font nd_options_color_greydark nd_donations_text_transform_uppercase" href="#nd_donations_single_cause_tab_stripe">'.__('Credit Card','nd-donations').'</a>
									</h4>
								</li>';
					...
					if ( get_option('nd_donations_stripe_public_key') != '' and get_option('nicdark_theme_author') == 1 ) {
						...
						$nd_donations_result .= '
						<div class="nd_donations_section" id="nd_donations_single_cause_tab_stripe">
							...
							<div class="nd_donations_section nd_donations_box_sizing_border_box">
							    ...
							    <div class="nd_donations_section nd_donations_padding_15 nd_donations_box_sizing_border_box nd_donations_border_1_solid_grey">
							        <div class="nd_donations_display_table nd_donations_float_left">
							            ...
							            <h6 class="nd_donations_padding_top_0 nd_donations_display_table_cell nd_donations_vertical_align_middle nd_options_color_grey"><span class="nd_options_color_greydark"><strong>'.__('NOTE','nd-donations').' : </strong></span>'.__('SECURE AND EASY PAYMENT','nd-donations').'</h6>
							        </div>
							    </div>
							...
							<form action="'.nd_donations_get_thankyou_page().'" method="post" id="payment-form" class="nd_donations_section">
							    
							    <div class="form-row nd_donations_margin_top_20 nd_donations_margin_bottom_20">
							        <div id="card-element"></div>
							        <div class="nd_donations_margin_top_10" id="card-errors" role="alert"></div>
							    </div>

							    <input type="hidden" name="nd_donations_single_cause_stripe" value="true">

							    <input type="hidden" name="nd_donations_title_cause" value="'.$nd_donations_title_cause.'">
								<input type="hidden" name="nd_donations_id" value="'.$nd_donations_id.'">

								<input id="nd_donations_stripe_value" type="hidden" name="nd_donations_stripe_value" value="">
								<input id="nd_donations_stripe_name" type="hidden" name="nd_donations_stripe_name" value="">
								<input id="nd_donations_stripe_surname" type="hidden" name="nd_donations_stripe_surname" value="">
								<input id="nd_donations_stripe_email" type="hidden" name="nd_donations_stripe_email" value="">
								<input id="nd_donations_stripe_message" type="hidden" name="nd_donations_stripe_message" value="">
								<input id="nd_donations_stripe_address" type="hidden" name="nd_donations_stripe_address" value="">
								<input id="nd_donations_stripe_city" type="hidden" name="nd_donations_stripe_city" value="">
								<input id="nd_donations_stripe_country" type="hidden" name="nd_donations_stripe_country" value="">

							    <input style="background-color:'.nd_donations_get_cause_color($nd_donations_id).';" class="nd_donations_border_radius_30 nd_donations_display_inline_block nd_donations_box_sizing_border_box nd_donations_color_white_important nd_options_first_font nd_donations_padding_10_20 nd_donations_cursor_pointer nd_donations_outline_0 nd_donations_font_size_15 nd_donations_border_width_0" type="submit" id="" name="" value="'.__('SUBMIT PAYMENT','nd-donations').'">
							...
							<!--//--><![CDATA[//><!--
							    ...
							    var stripe = Stripe("'.get_option('nd_donations_stripe_public_key').'");
