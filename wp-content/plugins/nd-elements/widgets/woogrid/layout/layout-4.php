...
<div class="nd_elements_section nd_elements_masonry_content">';
	...
	while ( $the_query->have_posts() ) : $the_query->the_post();
    	...
    	<div class=" '.$woogrid_width.' nd_elements_width_100_percentage_responsive nd_elements_float_left nd_elements_masonry_item nd_elements_padding_15 nd_elements_box_sizing_border_box nd_elements_text_align_center">
	    	...
	    	<a class="nd_elements_section" href="'.$nd_elements_permalink.'"><h5 class="nd_elements_line_height_1 nd_elements_font_weight_bold nd_elements_letter_spacing_2">'.$nd_elements_title.'</h5></a>
	    	<div class="nd_elements_section nd_elements_height_15"></div>
	    	<p class="nd_elements_line_height_1 nd_elements_margin_0_important nd_elements_padding_0 nd_elements_font_weight_normal">'.get_woocommerce_currency_symbol().' '.$nd_elements_price.'</p>
	    	<div class="nd_elements_section nd_elements_height_15"></div>	    	
	    	<a class="nd_elements_line_height_1 nd_elements_padding_10_20 nd_elements_font_size_12 nd_options_color_white nd_options_first_font nd_elements_font_weight_bold nd_elements_letter_spacing_2 " style="background-color:'.$woogrid_color.';" href="'.$nd_elements_permalink.'">'. __('READ MORE','nd-elements').'</a>
