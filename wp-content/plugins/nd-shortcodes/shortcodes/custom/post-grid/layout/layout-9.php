		  	...
		  	<div class="nd_options_section nd_options_position_relative">
		        ...
		        <div class="nd_options_bg_greydark_alpha_gradient_3 nd_options_position_absolute nd_options_left_0 nd_options_height_100_percentage nd_options_width_100_percentage nd_options_padding_30 nd_options_box_sizing_border_box">
				    <div class="nd_options_position_absolute nd_options_bottom_30">
				    	...
				    	<h5 class="nd_options_margin_0_important nd_options_padding_0 nd_options_second_font nd_options_color_white nd_options_font_size_12 nd_options_text_transform_uppercase nd_options_letter_spacing_3 nd_options_font_weight_lighter">'.$nd_options_post_categories_list.'</h5>
				        ...
				        <a class="nd_options_color_white nd_options_display_table_cell nd_options_vertical_align_middle nd_options_letter_spacing_3 nd_options_font_weight_lighter nd_options_font_size_11 nd_options_text_transform_uppercase" href="'.$nd_options_permalink.'">
				        	<span class="nd_options_float_left">'.__('READ MORE','nd-shortcodes').'</span>
				        	<img alt="" class="nd_options_float_left nd_options_margin_left_5 nd_options_margin_top_1" width="10" src="'.esc_url(plugins_url('icons/icon-arrow-right-white.svg', __FILE__ )).'">
				        </a>
