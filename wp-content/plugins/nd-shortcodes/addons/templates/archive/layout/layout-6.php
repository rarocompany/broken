...
if ( $nd_options_customizer_archives_archive_image_display != 1 ) { ?>
	...
	<div id="nd_options_archives_header_img_layout_6" class="nd_options_section nd_options_background_size_cover <?php echo $nd_options_customizer_archives_archive_image_position; ?> nd_options_bg_greydark" style="background-image:url(<?php echo $nd_options_customizer_archives_archive_image; ?>);">
            ...
            <div class="nd_options_container nd_options_clearfix">
                ...
                <div class="nd_options_section nd_options_padding_15 nd_options_box_sizing_border_box nd_options_text_align_center">
                    ...
                    <h1 class="nd_options_color_white nd_options_font_weight_normal nd_options_first_font">
                    	...
                    	<?php if (is_category()): ?>
							<span class="nd_options_display_block"><?php _e('CATEGORY','nd-shortcodes'); ?></span> <span class="nd_options_display_block nd_options_font_size_20 nd_options_second_font nd_options_margin_top_20 nd_options_letter_spacing_1  nd_options_text_transform_uppercase"><?php single_cat_title(); ?></span>
						...
						<?php elseif (is_tag()): ?>
							<span class="nd_options_display_block"><?php _e('TAG','nd-shortcodes'); ?></span> <span class="nd_options_display_block nd_options_font_size_20 nd_options_second_font nd_options_margin_top_20 nd_options_letter_spacing_1  nd_options_text_transform_uppercase"><?php single_tag_title() ?></span>
							<div class="nd_options_section"><span class="nd_options_bg_white nd_options_width_80 nd_options_height_4 nd_options_display_inline_block"></span></div>
						<?php elseif (is_month()): ?>
							<span class="nd_options_display_block"><?php _e('ARCHIVE FOR','nd-shortcodes'); ?></span> <span class="nd_options_display_block nd_options_font_size_20 nd_options_second_font nd_options_margin_top_20 nd_options_letter_spacing_1  nd_options_text_transform_uppercase"><?php single_month_title(' '); ?></span>
							<div class="nd_options_section"><span class="nd_options_bg_white nd_options_width_80 nd_options_height_4 nd_options_display_inline_block"></span></div>
						<?php elseif (is_author()): ?>
							<span class="nd_options_display_block"><?php _e('AUTHOR','nd-shortcodes'); ?></span> <span class="nd_options_display_block nd_options_font_size_20 nd_options_second_font nd_options_margin_top_20 nd_options_letter_spacing_1  nd_options_text_transform_uppercase"><?php the_author(); ?></span>
							<div class="nd_options_section"><span class="nd_options_bg_white nd_options_width_80 nd_options_height_4 nd_options_display_inline_block"></span></div>
