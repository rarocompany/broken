...
<style type="text/css">
    ...
    .nd_options_comments_ul li .reply a.comment-reply-link { font-family: '<?php echo $nd_options_font_family_p; ?>', sans-serif; }
...
<?php if ( have_comments() ) : ?>
    ...
    <!--START comment-->
    <div id="nd_options_comments" class=" nd_options_comments_template_l5 nd_options_section nd_options_margin_top_50 nd_options_padding_top_50 nd_options_border_top_2_solid_grey">
