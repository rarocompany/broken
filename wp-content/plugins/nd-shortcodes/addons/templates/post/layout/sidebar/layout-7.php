...
<style type="text/css">
    ...
    .nd_options_sidebar .widget.widget_calendar table caption { color: <?php echo $nd_options_customizer_font_color_h;  ?>; font-family: '<?php echo $nd_options_font_family_h; ?>', sans-serif; }
