...
if ( $nd_options_customizer_archives_search_image_display != 1 ) { ?>
	...
	<div id="nd_options_search_header_img_layout_3" class="nd_options_section nd_options_background_size_cover <?php echo $nd_options_customizer_archives_search_image_position; ?> nd_options_bg_greydark" style="background-image:url(<?php echo $nd_options_customizer_archives_search_image; ?>);">
