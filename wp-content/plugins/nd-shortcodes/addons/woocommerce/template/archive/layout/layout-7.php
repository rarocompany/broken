<div id="nd_options_woocommerce_archives_header_img_layout_7" class="nd_options_section nd_options_bg_greydark nd_options_background_size_cover <?php echo $nd_options_customizer_woocommerce_archive_products_header_image_position ?>" style="background-image:url(<?php echo $nd_options_customizer_woocommerce_archive_products_header_image_src; ?>);">
        ...
        <div class="nd_options_container nd_options_clearfix">
            ...
            <div class="nd_options_section nd_options_padding_15 nd_options_box_sizing_border_box nd_options_text_align_center">
                ...
                <h1 class="nd_options_color_white nd_options_font_weight_normal nd_options_first_font">
                    <span class="nd_options_display_block"><?php echo woocommerce_page_title(); ?></span>
